...
Version `0.1.0` was uploaded successfully on 2026-09-06 through [GitHub Actions](https://github.com/mariobilly/msch-pointillism/actions/runs/34037781410). The publisher is `mariobilly`, the repository publishing secret is configured, and the uploaded ZIP was downloaded and checked. Registry reported `NodeVersionStatusPending` at verification. Further releases require a new version number; do not republish `0.1.0`.
